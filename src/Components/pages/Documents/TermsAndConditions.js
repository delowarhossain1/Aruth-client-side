...
const TermsAndConditions = () => {
  return (
    <section className="py-5">
      ...
      <h5 className="mt-8 mb-3 text-lg font-semibold">TABLE OF CONTENTS</h5>
      <ul className=" list-decimal ml-7">
        <li>
          <a className="text-blue-500" href="#z">
            {" "}
            AGREEMENT TO TERMS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#y">
            {" "}
            INTELLECTUAL PROPERTY RIGHTS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#x">
            {" "}
            USER REPRESENTATIONS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#w">
            {" "}
            USER REGISTRATION
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#t">
            {" "}
            PRODUCTS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#s">
            {" "}
            PURCHASES AND PAYMENT
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#r">
            {" "}
            RETURN POLICY
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#q">
            {" "}
            PROHIBITED ACTIVITIES
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#p">
            {" "}
            USER GENERATED CONTRIBUTIONS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#o">
            {" "}
            CONTRIBUTION LICENSE
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#n">
            {" "}
            GUIDELINES FOR REVIEWS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#m">
            {" "}
            SUBMISSIONS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#l">
            {" "}
            SITE MANAGEMENT
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#k">
            {" "}
            PRIVACY POLICY
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#j">
            {" "}
            TERM AND TERMINATION
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#i">
            {" "}
            MODIFICATIONS AND INTERRUPTIONS
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#h">
            {" "}
            GOVERNING LAW
          </a>
        </li>
        ...
        <li>
          <a className="text-blue-500" href="#f">
            {" "}
            DISCLAIMER
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#e">
            {" "}
            LIMITATIONS OF LIABILITY
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#d">
            {" "}
            INDEMNIFICATION
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#c">
            {" "}
            USER DATA
          </a>
        </li>
        <li>
          <a className="text-blue-500" href="#b">
            {" "}
            MISCELLANEOUS
          </a>
        </li>
      ...
      <div id="z" className="mt-8">
        <h2 className="text-lg font-semibold">1. AGREEMENT TO TERMS</h2>
        <p className="text-justify text-gray-500">
          These Terms of Use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity (“you”) and ARUOT
          concerning your access to and use of the{" "}
          <a
            href="https://www.aruot.com/"
            target="_blank"
            rel="noreferrer"
          ...
          (collectively, the “Site”). We are registered in Bangladesh and have
          our registered office at Chattogram, Bangladesh, , . You agree that by
      ...
      <div id="x" className="mt-8">
        <h2 className="text-lg font-semibold mb-3">3. USER REPRESENTATIONS</h2>
        <h5>By using the Site, you represent and warrant that:</h5>
        <ul className="ml-7 list-decimal mt-2">
          <li>
            {" "}
        ...
        <p className="text-justify text-gray-500 mt-3">If you provide any information that is untrue, inaccurate, not current, or incomplete, we have the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof).</p>
      </div>

      <div id="w" className="mt-8">
        <h2 className="text-lg font-semibold">4. USER REGISTRATION</h2>
        <p className="text-justify text-gray-500">You may be required to register with the Site. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.</p>
      </div>

      <div id="t" className="mt-8">
        <h2 className="text-lg font-semibold">5. PRODUCTS</h2>
        <p className="text-justify text-gray-500">We make every effort to display as accurately as possible the colors, features, specifications, and details of the products available on the Site. However, we do not guarantee that the colors, features, specifications, and details of the products will be accurate, complete, reliable, current, or free of other errors, and your electronic display may not accurately reflect the actual colors and details of the products. All products are subject to availability, and we cannot guarantee that items will be in stock. We reserve the right to discontinue any products at any time for any reason. Prices for all products are subject to change.</p>
      </div>
      
      <div id="s" className="mt-8">
        ...
        <p className="text-justify text-gray-500">You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Site. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in TK.</p><br />

        <p className="text-justify text-gray-500">You agree to pay all charges at the prices then in effect for your purchases and any applicable shipping fees, and you authorize us to charge your chosen payment provider for any such amounts upon placing your order. We reserve the right to correct any errors or mistakes in pricing, even if we have already requested or received payment.</p><br />

        <p className="text-justify text-gray-500">We reserve the right to refuse any order placed through the Site. We may, in our sole discretion, limit or cancel quantities purchased per person, per household, or per order. These restrictions may include orders placed by or under the same customer account, the same payment method, and/or orders that use the same billing or shipping address. We reserve the right to limit or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers, or distributors.</p>

      </div>

      <div id="r" className="mt-8">
        <h2 className="text-lg font-semibold">7. RETURN POLICY</h2>
        <p className="text-justify text-gray-500">Please review our Return Policy posted on the Site prior to making any purchases.</p>
      </div>

      <div id="q" className="mt-8">
        <h2 className="text-lg font-semibold">8. PROHIBITED ACTIVITIES</h2>
        <p className="text-justify text-gray-500">You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>

        <h5 className="mt-3">As a user of the Site, you agree not to:</h5>
        <ul className="ml-7 list-disc">
      ...
      <div id="p" className="mt-8">
        ...
        <p className="text-justify text-gray-500">Any use of the Site or the Marketplace Offerings in violation of the foregoing violates these Terms of Use and may result in, among other things, termination or suspension of your rights to use the Site and the Marketplace Offerings.</p>
      </div>

      <div id="o" className="mt-8">
        <h2 className="text-lg font-semibold">10. CONTRIBUTION LICENSE</h2>
        <p className="text-justify text-gray-500">You and Site agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).</p><br />
        <p className="text-justify text-gray-500">By submitting suggestions or other feedback regarding the Site, you agree that we can use and share such feedback for any purpose without compensation to you.</p><br />
        <p className="text-justify text-gray-500">We do not assert any ownership over your Contributions. You retain full ownership of all of your Contributions and any intellectual property rights or other proprietary rights associated with your Contributions. We are not liable for any statements or representations in your Contributions provided by you in any area on the Site. You are solely responsible for your Contributions to the Site and you expressly agree to exonerate us from any and all responsibility and to refrain from any legal action against us regarding your Contributions.
</p>
      </div>

      <div id="n" className="mt-8">
        <h2 className="text-lg font-semibold">11. GUIDELINES FOR REVIEWS</h2>
        <p className="text-justify text-gray-500">We may provide you areas on the Site to leave reviews or ratings. When posting a review, you must comply with the following criteria:</p>
        ...
        <p className="text-justify text-gray-500 mt-2">We may accept, reject, or remove reviews in our sole discretion. We have absolutely no obligation to screen reviews or to delete reviews, even if anyone considers reviews objectionable or inaccurate. Reviews are not endorsed by us, and do not necessarily represent our opinions or the views of any of our affiliates or partners. We do not assume liability for any review or for any claims, liabilities, or losses resulting from any review. By posting a review, you hereby grant to us a perpetual, non-exclusive, worldwide, royalty-free, fully-paid, assignable, and sublicensable right and license to reproduce, modify, translate, transmit by any means, display, perform, and/or distribute all content relating to review.</p>
      </div>

      <div id="m" className="mt-8">
        <h2 className="text-lg font-semibold">12. SUBMISSIONS</h2>
        <p className="text-justify text-gray-500">You acknowledge and agree that any questions, comments, suggestions, ideas, feedback, or other information regarding the Site or the Marketplace Offerings ("Submissions") provided by you to us are non-confidential and shall become our sole property. We shall own exclusive rights, including all intellectual property rights, and shall be entitled to the unrestricted use and dissemination of these Submissions for any lawful purpose, commercial or otherwise, without acknowledgment or compensation to you. You hereby waive all moral rights to any such Submissions, and you hereby warrant that any such Submissions are original with you or that you have the right to submit such Submissions. You agree there shall be no recourse against us for any alleged or actual infringement or misappropriation of any proprietary right in your Submissions.
</p>

      </div>

      <div id="l" className="mt-8">
        <h2 className="text-lg font-semibold">13. SITE MANAGEMENT</h2>
        <p className="text-justify text-gray-500">We reserve the right, but not the obligation, to:</p>
      ...
      <div id="k" className="mt-8">
        <h2 className="text-lg font-semibold">14. PRIVACY POLICY</h2>
        <p className="text-justify text-gray-500">
We care about data privacy and security. By using the Site or the Marketplace Offerings, you agree to be bound by our Privacy Policy posted on the Site, which is incorporated into these Terms of Use. Please be advised the Site and the Marketplace Offerings are hosted in Bangladesh. If you access the Site or the Marketplace Offerings from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in Bangladesh, then through your continued use of the Site, you are transferring your data to Bangladesh, and you expressly consent to have your data transferred to and processed in Bangladesh .</p>

      </div>

      <div id="j" className="mt-8">
        <h2 className="text-lg font-semibold">15. TERM AND TERMINATION</h2>
        <p className="text-justify text-gray-500">These Terms of Use shall remain in full force and effect while you use the Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF THE SITE AND THE MARKETPLACE OFFERINGS (INCLUDING BLOCKING CERTAIN IP ADDRESSES), TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SITE AND THE MARKETPLACE OFFERINGS OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</p><br />

        <p className="text-justify text-gray-500">If we terminate or suspend your account for any reason, you are prohibited from registering and creating a new account under your name, a fake or borrowed name, or the name of any third party, even if you may be acting on behalf of the third party. In addition to terminating or suspending your account, we reserve the right to take appropriate legal action, including without limitation pursuing civil, criminal, and injunctive redress.</p>
      </div>

      <div id="i" className="mt-8">
        <h2 className="text-lg font-semibold">16. MODIFICATIONS AND INTERRUPTIONS</h2>
        <p className="text-justify text-gray-500">We reserve the right to change, modify, or remove the contents of the Site at any time or for any reason at our sole discretion without notice. However, we have no obligation to update any information on our Site. We also reserve the right to modify or discontinue all or part of the Marketplace Offerings without notice at any time. We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of the Site or the Marketplace Offerings.</p><br />
        <p className="text-justify text-gray-500">
We cannot guarantee the Site and the Marketplace Offerings will be available at all times. We may experience hardware, software, or other problems or need to perform maintenance related to the Site, resulting in interruptions, delays, or errors. We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify the Site or the Marketplace Offerings at any time or for any reason without notice to you. You agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access or use the Site or the Marketplace Offerings during any downtime or discontinuance of the Site or the Marketplace Offerings. Nothing in these Terms of Use will be construed to obligate us to maintain and support the Site or the Marketplace Offerings or to supply any corrections, updates, or releases in connection therewith.</p>
      ...
      <div id="h" className="mt-8">
        <h2 className="text-lg font-semibold">17. GOVERNING LAW</h2>
        <p className="text-justify text-gray-500">
These terms shall be governed by and defined following the laws of Bangladesh. ARUOT and yourself irrevocably consent that the courts of Bangladesh shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.</p>

      </div>

      <div id=""g className="mt-8">
        <h2 className="text-lg font-semibold">18. CORRECTIONS</h2>
        <p className="text-justify text-gray-500">There may be information on the Site that contains typographical errors, inaccuracies, or omissions that may relate to the Marketplace Offerings, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Site at any time, without prior notice.</p>

      </div>

      <div id="f" className="mt-8">
        <h2 className="text-lg font-semibold">19. DISCLAIMER</h2>
        <p className="text-justify text-gray-500">THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE OF THE SITE SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF THE SITE’S CONTENT OR THE CONTENT OF ANY WEBSITES LINKED TO THIS SITE AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY</p>
      ...
      <div id="e" className="mt-8">
        <h2 className="text-lg font-semibold">20. LIMITATIONS OF LIABILITY</h2>
        <p className="text-justify text-gray-500">IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL, OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA, OR OTHER DAMAGES ARISING FROM YOUR USE OF THE SITE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
</p>

  
      </div>

      <div id="d" className="mt-8">
        <h2 className="text-lg font-semibold">21. INDEMNIFICATION</h2>
        <p className="text-justify text-gray-500">
You agree to defend, indemnify, and hold us harmless, including our subsidiaries, affiliates, and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim, or demand, including reasonable attorneys’ fees and expenses, made by any third party due to or arising out of:</p>
      ...
      <div id="c" className="mt-8">
        <h2 className="text-lg font-semibold">22. USER DATA</h2>
        <p className="text-justify text-gray-500">We will maintain certain data that you transmit to the Site for the purpose of managing the performance of the Site, as well as data relating to your use of the Site. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Site. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>

      </div>

      <div id="b" className="mt-8">
        <h2 className="text-lg font-semibold">23. MISCELLANEOUS</h2>
        <p className="text-justify text-gray-500">These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the Site constitute the entire agreement and understanding between you and us. Our failure to exercise or enforce any right or provision of these Terms of Use shall not operate as a waiver of such right or provision. These Terms of Use operate to the fullest extent permissible by law. We may assign any or all of our rights and obligations to others at any time. We shall not be responsible or liable for any loss, damage, delay, or failure to act caused by any cause beyond our reasonable control. If any provision or part of a provision of these Terms of Use is determined to be unlawful, void, or unenforceable, that provision or part of the provision is deemed severable from these Terms of Use and does not affect the validity and enforceability of any remaining provisions. There is no joint venture, partnership, employment or agency relationship created between you and us as a result of these Terms of Use or use of the Site. You agree that these Terms of Use will not be construed against us by virtue of having drafted them. You hereby waive any and all defenses you may have based on the electronic form of these Terms of Use and the lack of signing by the parties hereto to execute these Terms of Use.</p>
      </div>

      <div id="a" className="mt-8">
        <h2 className="text-lg font-semibold">24. CONTACT US</h2>
        <p className="text-justify text-gray-500">In order to resolve a complaint regarding the Site or to receive further information regarding use of the Site, please contact us at:</p>

        <ul className="mt-3 ml-7">
            <li>ARUOT</li>
            <li>Chattogram, Bangladesh</li>
            <li>Bangladesh</li>
            <li>Phone: 01581817667</li>
            <li>support@aruot.com</li>
        </ul>
      </div>
